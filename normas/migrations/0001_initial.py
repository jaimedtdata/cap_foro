# Generated by Django 3.2 on 2021-08-10 10:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('norma_rne', models.CharField(help_text='Nombre RNE', max_length=50, verbose_name='RNE')),
                ...
                ('register_date_time', models.DateTimeField(auto_now_add=True, help_text='Fecha de Registro', verbose_name='Fecha de Registro')),
                ('area_name', models.ForeignKey(help_text='registro de Categoria', on_delete=django.db.models.deletion.CASCADE, to='normas.areas_normas', verbose_name='Tipo de Uso')),
                ('category_name', models.ForeignKey(help_text='registro de Categoria', on_delete=django.db.models.deletion.CASCADE, to='normas.categories_normas', verbose_name='Sub Tipo de Uso')),
                ...
                ('subcategory_name', models.ForeignKey(help_text='registro de SubCategoria', on_delete=django.db.models.deletion.CASCADE, to='normas.subcategories_normas', verbose_name='Tipo de Normativa')),
            ],
            options={
